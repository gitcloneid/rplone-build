	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Rr. Henning Gratyanis A" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Afif" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Havid" Width="120px" />
					</div>
				</div>

				<div data-aos="fade-up" data-aos-duration="120" className="">
					<img src="LineVertikal2.svg" alt="" className="relative top-[-4.0rem] " />
				</div>
				...
				<div className="lg:flex">
					...
					<img
						src="LineHorizontal.svg"
						alt=""
						className="relative top-[-5.0rem] hidden lg:flex"
						data-aos="fade-up"
						data-aos-duration="600"
					/>
				...
				<div
					className="flex gap-[10.6rem] relative top-[-6.0rem] lg:gap-[27.4rem]"
					data-aos="fade-up"
					data-aos-duration="800">
					<img src="LineKananKiri.svg" alt="" />
					<img src="LineKananKiri.svg" alt="" />
